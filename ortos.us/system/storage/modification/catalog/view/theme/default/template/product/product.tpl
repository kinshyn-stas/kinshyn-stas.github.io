    ...
    <div class="row" id="bord_det">
        ...
        <div class="container-fluid nopad">
            ...
            <div class="row">
                ...
                <div class="hidden-xs col-sm-4 col-md-2 col-lg-2 nopad">
                        <?php if ($images) { ?>
                            <div id="owl-additional" class="owl-carousel">
                                <?php if ($thumb) { ?>
                                
                                    <div class="item">
                                    <img src="<?php echo $min_thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>"/>
                                    </div>
                ...
                <div class="col-xs-12 col-sm-8 col-md-10 col-lg-10">
                        <?php if ($thumb) { ?>
                            ...
                            <?php if ($images) { ?>
                                <?php foreach ($images as $image) { ?>
                                    <div class="item">
                                    <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $image['main_thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
                                    </div>
...
<?php } ?>
      ...
      <div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <? /*** cgs ansertab ***/ ?>
                <li><a href="#tab-answertab" data-toggle="tab"><? echo $answertab_heading_title; ?></a></li>
            <? /*** cgs ansertab ***/ ?>
                ...
                <div class="tab-content">
                  ...
                  <?php } ?>
                   ...
                   <div class="tab-pane" id="tab-review"><div id="review"></div></div><?php if($smreview_status == 0 && $review_status) { ?>
...
$('#review').load('index.php?route=extension/module/smreview&product_id=<?php echo $product_id; ?>');
...
//--></script>
               	...
               	<script type="text/javascript"><!--
				  	$(document).ready(function() {
				      	...
				      	sync1.owlCarousel({
				        singleItem : true,
				        <?php if ($owlproduct_thumb_show_nav =='1') { ?>
				          navigation: true,
				        <?php } ?>
				        <?php if ($owlproduct_thumb_pagination_speed > 0) { ?>
				          paginationSpeed: <?php echo $owlproduct_thumb_pagination_speed; ?>,
				        <?php } ?>
				        <?php if ($owlproduct_thumb_slide_speed > 0) { ?>
				          slideSpeed : <?php echo $owlproduct_thumb_slide_speed; ?>,
				        <?php } ?>
				        <?php if ($owlproduct_thumb_show_page =='0') { ?>
				          pagination: false,
				        <?php } ?>
				        <?php if ($owlproduct_thumb_show_mouse_drag =='0') { ?>
				          mouseDrag: false,
				        <?php } ?>
				        <?php if ($owlproduct_thumb_show_touch_drag =='0') { ?>
				          touchDrag: false,
				        <?php } ?>
				      ...
				      sync2.owlCarousel({
				        items : <?php echo $owlproduct_visible; ?>,
				        itemsDesktop : [1000,<?php echo $owlproduct_visible_1000; ?>],
				        itemsDesktopSmall : [900,<?php echo $owlproduct_visible_900; ?>],
				        itemsTablet: [600,<?php echo $owlproduct_visible_600; ?>],
				        itemsMobile : [479,<?php echo $owlproduct_visible_479; ?>],
				        <?php if ($owlproduct_additional_show_nav =='1') { ?>
				          navigation: true,
				        <?php } ?>
				        <?php if ($owlproduct_additional_pagination_speed > 0) { ?>
				          paginationSpeed: <?php echo $owlproduct_additional_pagination_speed; ?>,
				        <?php } ?>
				        <?php if ($owlproduct_additional_slide_speed > 0) { ?>
				          slideSpeed : <?php echo $owlproduct_additional_slide_speed; ?>,
				        <?php } ?>
				        <?php if ($owlproduct_additional_show_page =='0') { ?>
				          pagination: false,
				        <?php } ?>
				        <?php if ($owlproduct_additional_show_mouse_drag =='0') { ?>
				          mouseDrag: false,
				        <?php } ?>
				        <?php if ($owlproduct_additional_show_touch_drag =='0') { ?>
				          touchDrag: false,
				        <?php } ?>
            ...
            <script>
                function loadSmreviews(page){
                    ...
                    $('#review').load('index.php?route=extension/module/smreview&product_id=<?php echo $product_id; ?>&page='+page);
                }
            </script>
