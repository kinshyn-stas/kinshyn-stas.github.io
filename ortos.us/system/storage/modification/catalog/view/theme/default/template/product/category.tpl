...
<div class="fon_catlist">
<a href="<?php echo $category['href']; ?>"><img src="<?php echo $category['thumb']; ?>" alt="<?php echo $category['name']; ?>" /></a>
<div class="zag_cattt"><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></div>
</div>
</div>
<?php } ?>
</div>
...
<?php } ?>
      ...
      <?php if ($thumb || $description) { ?>
        <div class="row">       
          <?php if ($description) { ?>
          <div class="col-sm-12 desc_cat"><?php echo $description; ?></div>
          <?php } ?>
        </div>
        <?php } ?>
