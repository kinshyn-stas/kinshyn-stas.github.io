        ...
        <div class="panel panel-default">
          ...
          <table class="table">
            <tr>
              ...
              <td><?php if ($customer) { ?>
                <a href="<?php echo $customer; ?>" target="_blank"><?php echo $firstname; ?> <?php echo $lastname; ?>  <?php echo $middlename; ?></a>
                <?php } else { ?>
                <?php echo $firstname; ?> <?php echo $lastname; ?>  <?php echo $middlename; ?>
                <?php } ?></td>
            </tr>
            <tr>
