  ...
  <ul class="nav pull-right">
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><?php if($alerts > 0) { ?><span class="label label-danger pull-left"><?php echo $alerts; ?></span><?php } ?> <i class="fa fa-bell fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
        ...
        <?php if (isset($smbpp_form_data['activate']) && $smbpp_form_data['activate'] && $smbpp_form_data['show_on_dashboard']) { ?>
        <!-- start: OCdevWizard SMBPP -->
        <li class="dropdown-header"><?php echo $text_smart_blog_pro_plus; ?></li>
        <li><a href="<?php echo $smart_blog_pro_plus_url; ?>" style="display: block; overflow: auto;"><span class="label label-warning pull-right"><?php echo $total_smart_blog_pro_plus_1; ?></span><?php echo $text_total_smart_blog_pro_plus_1; ?></a></li>
        <li><a href="<?php echo $smart_blog_pro_plus_url; ?>" style="display: block; overflow: auto;"><span class="label label-warning pull-right"><?php echo $total_smart_blog_pro_plus_2; ?></span><?php echo $text_total_smart_blog_pro_plus_2; ?></a></li>
        <li><a href="<?php echo $smart_blog_pro_plus_url; ?>" style="display: block; overflow: auto;"><span class="label label-warning pull-right"><?php echo $total_smart_blog_pro_plus_3; ?></span><?php echo $text_total_smart_blog_pro_plus_3; ?></a></li>
        <li><a href="<?php echo $smart_blog_pro_plus_url; ?>" style="display: block; overflow: auto;"><span class="label label-warning pull-right"><?php echo $total_smart_blog_pro_plus_5; ?>/<?php echo $total_smart_blog_pro_plus_4; ?></span><?php echo $text_total_smart_blog_pro_plus_4; ?></a></li>
        <li class="divider"></li>
        ...
        <li><a href="<?php echo $review; ?>"><span class="label label-danger pull-right"><?php echo $review_total; ?></span><?php echo $text_review; ?></a></li>
            ...
            <!-- cgs !-->
            <li><a href="<?php echo $ansewrtab; ?>"><span class="label label-danger pull-right"><?php echo $ansewrtab_total; ?></span><? echo $answer_text; ?></a></li>
            <!-- cgs !-->
