        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
                ...
                <li><a href="#tab-owlproduct" data-toggle="tab"><?php echo $tab_owlproduct; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
                ...
                <div class="tab-pane" id="tab-owlproduct">
	              	<fieldset>
		                <legend><?php echo $text_owlproduct_thumb; ?></legend>
		                <div class="form-group">
		                  <label class="col-sm-2 control-label"><?php echo $entry_owlproduct_show_page; ?></label>
		                  <div class="col-sm-10">
		                    <label class="radio-inline">
		                      <?php if ($config_owlproduct_thumb_show_page) { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_page" value="1" checked="checked" />
		                      <?php echo $text_yes; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_page" value="1" />
		                      <?php echo $text_yes; ?>
		                      <?php } ?>
		                    </label>
		                    <label class="radio-inline">
		                      <?php if (!$config_owlproduct_thumb_show_page) { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_page" value="0" checked="checked" />
		                      <?php echo $text_no; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_page" value="0" />
		                      <?php echo $text_no; ?>
		                      <?php } ?>
		                    </label>
		                  </div>
		                ...
		                <div class="form-group">
		                  <label class="col-sm-2 control-label"><?php echo $entry_owlproduct_show_nav; ?></label>
		                  <div class="col-sm-10">
		                    <label class="radio-inline">
		                      <?php if ($config_owlproduct_thumb_show_nav) { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_nav" value="1" checked="checked" />
		                      <?php echo $text_yes; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_nav" value="1" />
		                      <?php echo $text_yes; ?>
		                      <?php } ?>
		                    </label>
		                    <label class="radio-inline">
		                      <?php if (!$config_owlproduct_thumb_show_nav) { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_nav" value="0" checked="checked" />
		                      <?php echo $text_no; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_nav" value="0" />
		                      <?php echo $text_no; ?>
		                      <?php } ?>
		                    </label>
		                  </div>
		                ...
		                <div class="form-group">
		                  <label class="col-sm-2 control-label"><?php echo $entry_owlproduct_show_mouse_drag; ?></label>
		                  <div class="col-sm-10">
		                    <label class="radio-inline">
		                      <?php if ($config_owlproduct_thumb_show_mouse_drag) { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_mouse_drag" value="1" checked="checked" />
		                      <?php echo $text_yes; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_mouse_drag" value="1" />
		                      <?php echo $text_yes; ?>
		                      <?php } ?>
		                    </label>
		                    <label class="radio-inline">
		                      <?php if (!$config_owlproduct_thumb_show_mouse_drag) { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_mouse_drag" value="0" checked="checked" />
		                      <?php echo $text_no; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_mouse_drag" value="0" />
		                      <?php echo $text_no; ?>
		                      <?php } ?>
		                    </label>
		                  </div>
		                ...
		                <div class="form-group">
		                  <label class="col-sm-2 control-label"><?php echo $entry_owlproduct_show_touch_drag; ?></label>
		                  <div class="col-sm-10">
		                    <label class="radio-inline">
		                      <?php if ($config_owlproduct_thumb_show_touch_drag) { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_touch_drag" value="1" checked="checked" />
		                      <?php echo $text_yes; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_touch_drag" value="1" />
		                      <?php echo $text_yes; ?>
		                      <?php } ?>
		                    </label>
		                    <label class="radio-inline">
		                      <?php if (!$config_owlproduct_thumb_show_touch_drag) { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_touch_drag" value="0" checked="checked" />
		                      <?php echo $text_no; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_thumb_show_touch_drag" value="0" />
		                      <?php echo $text_no; ?>
		                      <?php } ?>
		                    </label>
		                  </div>
		                ...
		                <div class="form-group">
		                  <label class="col-sm-2 control-label" for="input-owlproduct-thumb-slide-speed"><span data-toggle="tooltip" title="<?php echo $help_owlproduct_slide_speed; ?>"><?php echo $entry_owlproduct_slide_speed; ?></span></label>
		                  <div class="col-sm-10">
		                    <input type="text" name="config_owlproduct_thumb_slide_speed" value="<?php echo $config_owlproduct_thumb_slide_speed; ?>" placeholder="<?php echo $entry_owlproduct_slide_speed; ?>" id="input-owlproduct-thumb-slide-speed" class="form-control" />
		                  </div>
		                </div>
		                <div class="form-group">
		                  <label class="col-sm-2 control-label" for="input-owlproduct-thumb-pagination_speed"><span data-toggle="tooltip" title="<?php echo $help_owlproduct_pagination_speed; ?>"><?php echo $entry_owlproduct_pagination_speed; ?></span></label>
		                  <div class="col-sm-10">
		                    <input type="text" name="config_owlproduct_thumb_pagination_speed" value="<?php echo $config_owlproduct_thumb_pagination_speed; ?>" placeholder="<?php echo $entry_owlproduct_slide_speed; ?>" id="input-owlproduct-thumb-pagination_speed" class="form-control" />
		                  </div>
		                </div>
		                <legend><?php echo $text_owlproduct_additional; ?></legend>
		                <div class="form-group">
		                  <label class="col-sm-2 control-label"><?php echo $entry_owlproduct_show_page; ?></label>
		                  <div class="col-sm-10">
		                    <label class="radio-inline">
		                      <?php if ($config_owlproduct_additional_show_page) { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_page" value="1" checked="checked" />
		                      <?php echo $text_yes; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_page" value="1" />
		                      <?php echo $text_yes; ?>
		                      <?php } ?>
		                    </label>
		                    <label class="radio-inline">
		                      <?php if (!$config_owlproduct_additional_show_page) { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_page" value="0" checked="checked" />
		                      <?php echo $text_no; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_page" value="0" />
		                      <?php echo $text_no; ?>
		                      <?php } ?>
		                    </label>
		                  </div>
		                ...
		                <div class="form-group">
		                  ...
		                  <div class="col-sm-10">
		                    <label class="radio-inline">
		                      <?php if ($config_owlproduct_additional_show_nav) { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_nav" value="1" checked="checked" />
		                      <?php echo $text_yes; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_nav" value="1" />
		                      <?php echo $text_yes; ?>
		                      <?php } ?>
		                    </label>
		                    <label class="radio-inline">
		                      <?php if (!$config_owlproduct_additional_show_nav) { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_nav" value="0" checked="checked" />
		                      <?php echo $text_no; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_nav" value="0" />
		                      <?php echo $text_no; ?>
		                      <?php } ?>
		                    </label>
		                  </div>
		                ...
		                <div class="form-group">
		                  ...
		                  <div class="col-sm-10">
		                    <label class="radio-inline">
		                      <?php if ($config_owlproduct_additional_show_mouse_drag) { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_mouse_drag" value="1" checked="checked" />
		                      <?php echo $text_yes; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_mouse_drag" value="1" />
		                      <?php echo $text_yes; ?>
		                      <?php } ?>
		                    </label>
		                    <label class="radio-inline">
		                      <?php if (!$config_owlproduct_additional_show_mouse_drag) { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_mouse_drag" value="0" checked="checked" />
		                      <?php echo $text_no; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_mouse_drag" value="0" />
		                      <?php echo $text_no; ?>
		                      <?php } ?>
		                    </label>
		                  </div>
		                ...
		                <div class="form-group">
		                  ...
		                  <div class="col-sm-10">
		                    <label class="radio-inline">
		                      <?php if ($config_owlproduct_additional_show_touch_drag) { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_touch_drag" value="1" checked="checked" />
		                      <?php echo $text_yes; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_touch_drag" value="1" />
		                      <?php echo $text_yes; ?>
		                      <?php } ?>
		                    </label>
		                    <label class="radio-inline">
		                      <?php if (!$config_owlproduct_additional_show_touch_drag) { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_touch_drag" value="0" checked="checked" />
		                      <?php echo $text_no; ?>
		                      <?php } else { ?>
		                      <input type="radio" name="config_owlproduct_additional_show_touch_drag" value="0" />
		                      <?php echo $text_no; ?>
		                      <?php } ?>
		                    </label>
		                  </div>
		                ...
		                <div class="form-group">
		                  <label class="col-sm-2 control-label" for="input-owlproduct-additional-slide-speed"><span data-toggle="tooltip" title="<?php echo $help_owlproduct_slide_speed; ?>"><?php echo $entry_owlproduct_slide_speed; ?></span></label>
		                  <div class="col-sm-10">
		                    <input type="text" name="config_owlproduct_additional_slide_speed" value="<?php echo $config_owlproduct_additional_slide_speed; ?>" placeholder="<?php echo $entry_owlproduct_slide_speed; ?>" id="input-owlproduct-additional-slide-speed" class="form-control" />
		                  </div>
		                </div>
		                <div class="form-group">
		                  <label class="col-sm-2 control-label" for="input-owlproduct-additional-pagination_speed"><span data-toggle="tooltip" title="<?php echo $help_owlproduct_pagination_speed; ?>"><?php echo $entry_owlproduct_pagination_speed; ?></span></label>
		                  <div class="col-sm-10">
		                    <input type="text" name="config_owlproduct_additional_pagination_speed" value="<?php echo $config_owlproduct_additional_pagination_speed; ?>" placeholder="<?php echo $entry_owlproduct_slide_speed; ?>" id="input-owlproduct-additional-pagination_speed" class="form-control" />
		                  </div>
		                </div>
		                <div class="form-group">
		                  <label class="col-sm-2 control-label" for="input-owlproduct-additional-visible"><span data-toggle="tooltip" title="<?php echo $help_owlproduct_visible; ?>"><?php echo $entry_owlproduct_visible; ?></span></label>
		                  <div class="col-sm-10">
		                    <input type="text" name="config_owlproduct_visible" value="<?php echo $config_owlproduct_visible; ?>" placeholder="<?php echo $entry_owlproduct_visible; ?>" id="input-owlproduct-additional-visible" class="form-control" />
		                  </div>
		                </div>
		                <div class="form-group">
		                  <label class="col-sm-2 control-label" for="input-owlproduct-additional-visible-1000"><span data-toggle="tooltip" title="<?php echo $help_owlproduct_visible_1000; ?>"><?php echo $entry_owlproduct_visible_1000; ?></span></label>
		                  <div class="col-sm-10">
		                    <input type="text" name="config_owlproduct_visible_1000" value="<?php echo $config_owlproduct_visible_1000; ?>" placeholder="<?php echo $entry_owlproduct_visible_1000; ?>" id="input-owlproduct-additional-visible-1000" class="form-control" />
		                  </div>
		                </div>
		                <div class="form-group">
		                  <label class="col-sm-2 control-label" for="input-owlproduct-additional-visible-900"><span data-toggle="tooltip" title="<?php echo $help_owlproduct_visible_900; ?>"><?php echo $entry_owlproduct_visible_900; ?></span></label>
		                  <div class="col-sm-10">
		                    <input type="text" name="config_owlproduct_visible_900" value="<?php echo $config_owlproduct_visible_900; ?>" placeholder="<?php echo $entry_owlproduct_visible_900; ?>" id="input-owlproduct-additional-visible-900" class="form-control" />
		                  </div>
		                </div>
		                <div class="form-group">
		                  <label class="col-sm-2 control-label" for="input-owlproduct-additional-visible-600"><span data-toggle="tooltip" title="<?php echo $help_owlproduct_visible_600; ?>"><?php echo $entry_owlproduct_visible_600; ?></span></label>
		                  <div class="col-sm-10">
		                    <input type="text" name="config_owlproduct_visible_600" value="<?php echo $config_owlproduct_visible_600; ?>" placeholder="<?php echo $entry_owlproduct_visible_600; ?>" id="input-owlproduct-additional-visible-600" class="form-control" />
		                  </div>
		                </div>
		                <div class="form-group">
		                  <label class="col-sm-2 control-label" for="input-owlproduct-additional-visible-479"><span data-toggle="tooltip" title="<?php echo $help_owlproduct_visible_479; ?>"><?php echo $entry_owlproduct_visible_479; ?></span></label>
		                  <div class="col-sm-10">
		                    <input type="text" name="config_owlproduct_visible_479" value="<?php echo $config_owlproduct_visible_479; ?>" placeholder="<?php echo $entry_owlproduct_visible_479; ?>" id="input-owlproduct-additional-visible-479" class="form-control" />
		                  </div>
		                </div>
	            	</fieldset>
            	</div>
