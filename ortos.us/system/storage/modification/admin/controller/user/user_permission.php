...
class ControllerUserUserPermission extends Controller {
	...
	protected function getForm() {
        ...
        if (version_compare(VERSION, '2.2.0.0', '<=') && !in_array('extension/ocdevwizard/smart_blog_pro_plus', $data['permissions'])) {
          $data['permissions'][] = 'extension/ocdevwizard/smart_blog_pro_plus';
        }
