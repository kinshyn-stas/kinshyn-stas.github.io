...
class ControllerStartupPermission extends Controller {
	public function index() {
        ...
        // start: OCdevWizard OCdevWizard
        'extension/ocdevwizard',
        // end: OCdevWizard OCdevWizard
        ...
        'ocdevwizard/smart_checkout',
        'ocdevwizard/smart_checkout_notifications',
        // end: OCdevWizard SMCH
      

        // start: OCdevWizard SMBPP
        'extension/ocdevwizard/smart_blog_pro_plus',
