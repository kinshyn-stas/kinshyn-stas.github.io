...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
            ...
            /* ProductBundles - Begin */
			$catalog[] = array(
				'id'       => 'menu-productbundles',
				'icon'	   => 'fa fa-shopping-cart fa-fw', 
				'name'	   => 'Вместе дешевле',
				'href'     => $this->url->link('extension/module/productbundles', 'token=' . $this->session->data['token'], true),
				'children' => array()
			);	
            /* ProductBundles - End */
            ...
            /*** cgs answertab ***/
            if ($this->user->hasPermission('access', 'catalog/answertab')) {
                $this->load->language('catalog/answertab');
                $catalog[] = array(
                    'name'	   => $this->language->get('heading_title'),
                    'href'     => $this->url->link('catalog/answertab', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
			/*** cgs answertab ***/
            ...
            if ($this->user->hasPermission('access', 'extension/module/smcallme')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_smcallme'),
					'href'     => $this->url->link('extension/module/smcallme/getlist', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			if ($this->user->hasPermission('access', 'extension/module/smreview')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_smreview'),
					'href'     => $this->url->link('extension/module/smreview/getlist', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
            ...
            $gallery = array();
            if ($this->user->hasPermission('access', 'extension/module/opencart_gallery_manager')) {
                $gallery[] = array(
                    'name'     => 'Обзор',
            ...
            if ($this->user->hasPermission('access', 'opencart_gallery/album')) {
                $gallery[] = array(
                    'name'     => 'Фотоальбомы',
                    'href'     => $this->url->link('opencart_gallery/album', 'token=' . $this->session->data['token'], true),
                    'children' => array()   
                );
            }
            if ($this->user->hasPermission('access', 'opencart_gallery/video')) {
                $gallery[] = array(
                    'name'     => 'Видео',
                    'href'     => $this->url->link('opencart_gallery/video', 'token=' . $this->session->data['token'], true),
                    'children' => array()   
                );
            }
            if ($this->user->hasPermission('access', 'opencart_gallery/setting')) {
                $gallery[] = array(
                    'name'     => 'Настройки',
                    'href'     => $this->url->link('opencart_gallery/setting', 'token=' . $this->session->data['token'], true),
                    'children' => array()   
                );
            }
            if ($gallery) {
			...
			*/
			...
			if ($this->user->hasPermission('access', 'extension/module/exchange1c')) {
				$extension[] = array(
        ...
        $smac[] = array(
          'name'     => $this->language->get('text_smart_checkout_setting_left_menu'),
          'href'     => $this->url->link('ocdevwizard/smart_checkout', 'token=' . $this->session->data['token'], true),
          'children' => array()
        );    

        $smac[] = array(
          'name'     => $this->language->get('text_smart_checkout_email_left_menu'),
          'href'     => $this->url->link('ocdevwizard/smart_checkout_notifications', 'token=' . $this->session->data['token'], true),
          'children' => array()
        );

        $ocdevwizard[] = array(
          'name'     => $this->language->get('text_smart_checkout_left_menu'),
          'href'     => '',
          'children' => $smac
        );
        ...
        if (version_compare(VERSION, '3.0.0.0', '>=')) {
          $ocdevwizard[] = array(
            'name'     => $this->language->get('text_smart_blog_pro_plus_left_menu'),
            'href'     => $this->url->link('extension/ocdevwizard/smart_blog_pro_plus', 'user_token='.$this->session->data['user_token'].'&store_id=0', true),
            'children' => array()
          );
        } else {
          $ocdevwizard[] = array(
            'name'     => $this->language->get('text_smart_blog_pro_plus_left_menu'),
            'href'     => $this->url->link('extension/ocdevwizard/smart_blog_pro_plus', 'token='.$this->session->data['token'].'&store_id=0', true),
            'children' => array()
          );
        }
