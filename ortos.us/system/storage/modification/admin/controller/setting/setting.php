	...
	public function index() {
	  ...
	  $this->request->post['config_mail_regexp'] = trim($this->request->post['config_mail_regexp']);
		...
		$data['tab_mail'] = $this->language->get('tab_mail');
                ...
                $data['tab_owlproduct'] 				   = $this->language->get('tab_owlproduct');
				$data['text_owlproduct_thumb'] 			   = $this->language->get('text_owlproduct_thumb');
				$data['text_owlproduct_additional'] 	   = $this->language->get('text_owlproduct_additional');
		        $data['entry_owlproduct_visible']          = $this->language->get('entry_owlproduct_visible');
		        $data['entry_owlproduct_visible_1000']     = $this->language->get('entry_owlproduct_visible_1000');
		        $data['entry_owlproduct_visible_900']      = $this->language->get('entry_owlproduct_visible_900');
		        $data['entry_owlproduct_visible_600']      = $this->language->get('entry_owlproduct_visible_600');
		        $data['entry_owlproduct_visible_479']      = $this->language->get('entry_owlproduct_visible_479');
		        $data['entry_owlproduct_slide_speed']      = $this->language->get('entry_owlproduct_slide_speed');
		        $data['entry_owlproduct_pagination_speed'] = $this->language->get('entry_owlproduct_pagination_speed');
		        $data['entry_owlproduct_show_page']        = $this->language->get('entry_owlproduct_show_page');
		        $data['entry_owlproduct_show_nav']         = $this->language->get('entry_owlproduct_show_nav');
		        $data['entry_owlproduct_show_lazy_load']   = $this->language->get('entry_owlproduct_show_lazy_load');
		        $data['entry_owlproduct_show_mouse_drag']  = $this->language->get('entry_owlproduct_show_mouse_drag');
		        $data['entry_owlproduct_show_touch_drag']  = $this->language->get('entry_owlproduct_show_touch_drag');
		        $data['help_owlproduct_visible']           = $this->language->get('help_owlproduct_visible');
		        $data['help_owlproduct_visible_1000']      = $this->language->get('help_owlproduct_visible_1000');
		        $data['help_owlproduct_visible_900']       = $this->language->get('help_owlproduct_visible_900');
		        $data['help_owlproduct_visible_600']       = $this->language->get('help_owlproduct_visible_600');
		        $data['help_owlproduct_visible_479']       = $this->language->get('help_owlproduct_visible_479');
		        $data['help_owlproduct_slide_speed']       = $this->language->get('help_owlproduct_slide_speed');
		        $data['help_owlproduct_pagination_speed']  = $this->language->get('help_owlproduct_pagination_speed');
		...
		if (isset($this->request->post['config_langdata'])) {
			...
			$data['config_langdata'] = $this->config->get('config_langdata');
                ...
                if (isset($this->request->post['config_owlproduct_thumb_show_page'])) {
					$data['config_owlproduct_thumb_show_page'] = $this->request->post['config_owlproduct_thumb_show_page'];
				} else {
					$data['config_owlproduct_thumb_show_page'] = $this->config->get('config_owlproduct_thumb_show_page');
				}

				if (isset($this->request->post['config_owlproduct_thumb_show_nav'])) {
					$data['config_owlproduct_thumb_show_nav'] = $this->request->post['config_owlproduct_thumb_show_nav'];
				} else {
					$data['config_owlproduct_thumb_show_nav'] = $this->config->get('config_owlproduct_thumb_show_nav');
				}

				if (isset($this->request->post['config_owlproduct_thumb_show_mouse_drag'])) {
					$data['config_owlproduct_thumb_show_mouse_drag'] = $this->request->post['config_owlproduct_thumb_show_mouse_drag'];
				} else {
					$data['config_owlproduct_thumb_show_mouse_drag'] = $this->config->get('config_owlproduct_thumb_show_mouse_drag');
				}

				if (isset($this->request->post['config_owlproduct_thumb_show_touch_drag'])) {
					$data['config_owlproduct_thumb_show_touch_drag'] = $this->request->post['config_owlproduct_thumb_show_touch_drag'];
				} else {
					$data['config_owlproduct_thumb_show_touch_drag'] = $this->config->get('config_owlproduct_thumb_show_touch_drag');
				}

				if (isset($this->request->post['config_owlproduct_thumb_slide_speed'])) {
					$data['config_owlproduct_thumb_slide_speed'] = $this->request->post['config_owlproduct_thumb_slide_speed'];
				} elseif ($this->config->get('config_owlproduct_thumb_slide_speed')) {
					$data['config_owlproduct_thumb_slide_speed'] = $this->config->get('config_owlproduct_thumb_slide_speed');
				} else {
					$data['config_owlproduct_thumb_slide_speed'] = '200';
				}

				if (isset($this->request->post['config_owlproduct_thumb_pagination_speed'])) {
					$data['config_owlproduct_thumb_pagination_speed'] = $this->request->post['config_owlproduct_thumb_pagination_speed'];
				} elseif ($this->config->get('config_owlproduct_thumb_pagination_speed')) {
					$data['config_owlproduct_thumb_pagination_speed'] = $this->config->get('config_owlproduct_thumb_pagination_speed');
				} else {
					$data['config_owlproduct_thumb_pagination_speed'] = '800';
				}
				
				if (isset($this->request->post['config_owlproduct_additional_show_page'])) {
					$data['config_owlproduct_additional_show_page'] = $this->request->post['config_owlproduct_additional_show_page'];
				} else {
					$data['config_owlproduct_additional_show_page'] = $this->config->get('config_owlproduct_additional_show_page');
				}

				if (isset($this->request->post['config_owlproduct_additional_show_nav'])) {
					$data['config_owlproduct_additional_show_nav'] = $this->request->post['config_owlproduct_additional_show_nav'];
				} else {
					$data['config_owlproduct_additional_show_nav'] = $this->config->get('config_owlproduct_additional_show_nav');
				}

				if (isset($this->request->post['config_owlproduct_additional_show_mouse_drag'])) {
					$data['config_owlproduct_additional_show_mouse_drag'] = $this->request->post['config_owlproduct_additional_show_mouse_drag'];
				} else {
					$data['config_owlproduct_additional_show_mouse_drag'] = $this->config->get('config_owlproduct_additional_show_mouse_drag');
				}

				if (isset($this->request->post['config_owlproduct_additional_show_touch_drag'])) {
					$data['config_owlproduct_additional_show_touch_drag'] = $this->request->post['config_owlproduct_additional_show_touch_drag'];
				} else {
					$data['config_owlproduct_additional_show_touch_drag'] = $this->config->get('config_owlproduct_additional_show_touch_drag');
				}

				if (isset($this->request->post['config_owlproduct_additional_slide_speed'])) {
					$data['config_owlproduct_additional_slide_speed'] = $this->request->post['config_owlproduct_additional_slide_speed'];
				} elseif ($this->config->get('config_owlproduct_additional_slide_speed')) {
					$data['config_owlproduct_additional_slide_speed'] = $this->config->get('config_owlproduct_additional_slide_speed');
				} else {
					$data['config_owlproduct_additional_slide_speed'] = '200';
				}

				if (isset($this->request->post['config_owlproduct_additional_pagination_speed'])) {
					$data['config_owlproduct_additional_pagination_speed'] = $this->request->post['config_owlproduct_additional_pagination_speed'];
				} elseif ($this->config->get('config_owlproduct_additional_pagination_speed')) {
					$data['config_owlproduct_additional_pagination_speed'] = $this->config->get('config_owlproduct_additional_pagination_speed');
				} else {
					$data['config_owlproduct_additional_pagination_speed'] = '800';
				}

				if (isset($this->request->post['config_owlproduct_visible'])) {
					$data['config_owlproduct_visible'] = $this->request->post['config_owlproduct_visible'];
				} elseif ($this->config->get('config_owlproduct_visible')) {
					$data['config_owlproduct_visible'] = $this->config->get('config_owlproduct_visible');
				} else {
					$data['config_owlproduct_visible'] = '5';
				}

				if (isset($this->request->post['config_owlproduct_visible_1000'])) {
					$data['config_owlproduct_visible_1000'] = $this->request->post['config_owlproduct_visible_1000'];
				} elseif ($this->config->get('config_owlproduct_visible_1000')) {
					$data['config_owlproduct_visible_1000'] = $this->config->get('config_owlproduct_visible_1000');
				} else {
					$data['config_owlproduct_visible_1000'] = '4';
				}

				if (isset($this->request->post['config_owlproduct_visible_900'])) {
					$data['config_owlproduct_visible_900'] = $this->request->post['config_owlproduct_visible_900'];
				} elseif ($this->config->get('config_owlproduct_visible_900')) {
					$data['config_owlproduct_visible_900'] = $this->config->get('config_owlproduct_visible_900');
				} else {
					$data['config_owlproduct_visible_900'] = '3';
				}

				if (isset($this->request->post['config_owlproduct_visible_600'])) {
					$data['config_owlproduct_visible_600'] = $this->request->post['config_owlproduct_visible_600'];
				} elseif ($this->config->get('config_owlproduct_visible_600')) {
					$data['config_owlproduct_visible_600'] = $this->config->get('config_owlproduct_visible_600');
				} else {
					$data['config_owlproduct_visible_600'] = '2';
				}

				if (isset($this->request->post['config_owlproduct_visible_479'])) {
					$data['config_owlproduct_visible_479'] = $this->request->post['config_owlproduct_visible_479'];
				} elseif ($this->config->get('config_owlproduct_visible_479')) {
					$data['config_owlproduct_visible_479'] = $this->config->get('config_owlproduct_visible_479');
				} else {
					$data['config_owlproduct_visible_479'] = '2';
				}
