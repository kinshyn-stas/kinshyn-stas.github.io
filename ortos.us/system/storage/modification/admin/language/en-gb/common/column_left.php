...
$_['heading_title_uninstaller'] = 'Extension Uninstaller';
        ...
        $_['text_smart_checkout_left_menu'] = 'Smart Checkout';
        $_['text_smart_checkout_setting_left_menu'] = 'Main settings';
        $_['text_smart_checkout_email_left_menu'] = 'Email templates';
        // end: OCdevWizard SMCH
      

        // start: OCdevWizard SMBPP
        $_['text_smart_blog_pro_plus_left_menu'] = 'Smart Blog Pro Plus';
