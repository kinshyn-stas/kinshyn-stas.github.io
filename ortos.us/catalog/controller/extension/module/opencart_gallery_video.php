<?php
class ControllerExtensionModuleOpencartGalleryVideo extends Controller {
	public function index() {
		$setting = $this->config->get('opencart_gallery_video_module');
		...
		$this->load->language('extension/module/opencart_gallery_video');
		...
		if ($data['videos']) {
			...
			return $this->load->view('extension/module/opencart_gallery_video', $data);
