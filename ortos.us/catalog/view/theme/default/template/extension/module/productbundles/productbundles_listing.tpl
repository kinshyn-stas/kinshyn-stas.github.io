<?php echo $header; ?>
<?php if(!empty($moduleData['ListingCustomCSS'])): ?>
    <style>
        <?php echo htmlspecialchars_decode($moduleData['ListingCustomCSS']); ?>
    </style>
<?php endif; ?>
<div class="container">
    <ul class="breadcrumb">
            	...
            	<?php foreach ($Bundles as $Bundle) { ?>
                	<div class="pbListing-box box-productbundles">
                    	<div class="box-content">
                            <?php if (isset($Bundle['BundleName'])) { ?>
                                <div class="bundle-list-name">
                                	<a href="<?php echo $Bundle['url']; ?>"><?php echo $Bundle['BundleName']; ?></a>
                                 </div>
                            <?php } ?>
                        	<?php $i=0; ?>
