...
class ControllerExtensionModuleSeoUrlGenerator extends Controller {
	private $error = array(); 
        ...
        private $simple_blog;
        private $this_version = '2.5.3.0';
        private $this_extension = 'ocext_seourlgenerator';
		...
		$this->document->setTitle($this->language->get('heading_title'));
			...
			$sort = array('categories'=>$this->request->get['categories']);
                ...
                //v1.1
                elseif (isset($this->request->get['informations'])) {
                ...
                ///v.1.1
                //v.1.2
                elseif($this->simple_blog && isset($this->request->get['simpleblogarticles'])){
        ...
        protected function save() {
            ...
            ///v1.1
            //v1.2
            elseif(isset($this->request->get['simpleblogarticles'])){
		...
		sleep(1);
		$this->load->language('extension/module/seourlgenerator');
