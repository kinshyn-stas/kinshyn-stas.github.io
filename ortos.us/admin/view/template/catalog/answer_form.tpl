        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <button type="submit" form="form-answer" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary">
        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-answer" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-text_answer"><? echo $label_text_edit; ?></label>
                            <div class="col-sm-10">
                                <textarea name="text_answer" cols="60" rows="8" placeholder="<?php echo $entry_text; ?>" id="input-text_answer" class="form-control"><?php echo $text_answer; ?></textarea>
                                <?php if ($error_text) { ?>
                                    <div class="text-danger"><?php echo $error_text; ?></div>
                                <?php } ?>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="sendToAuthor" value="1"> <? echo $text_sendToAuthor; ?>
                                    </label>
                                </div>
