              ...
              <div class="table-responsive">
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="3"></td>
                      <td class="text-left"><button type="button" onclick="addMultiImage();" data-toggle="tooltip" title="<?php echo $button_image_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div>
...
function addMultiImage() {
    $('#modal-image').remove();
    $.ajax({
        url: 'index.php?route=common/galleryfilemanager&token=' + getURLVar('token') + '&image_row=' + image_row,
        dataType: 'html',
        beforeSend: function() {
