...
<div id="content">
	<div class="page-header">
	    <div class="container-fluid">
	      ...
	      <h1><?php echo $column_options_bulk; ?></h1>
	    </div>
  	</div>
	<div class="container-fluid">
	    ...
	    <div class="panel panel-default">
	    	<div class="panel-heading">
	        	<h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $column_options; ?></h3>
	    	</div>
	    	<div class="panel-body">
	    		<form action="<?php echo $action ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">	    
	    			<ul class="nav nav-tabs">
			            <li class="active"><a href="#tab-option" data-toggle="tab"><?php echo $tab_text_insert; ?></a></li>
			        ...
			        <div class="tab-content">
			            ...
			            <div class="tab-pane" id="tab-delete">
			            	<?php echo $text_delete_info_opts ?><br /><br />
