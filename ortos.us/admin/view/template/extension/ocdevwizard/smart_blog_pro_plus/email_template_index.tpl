            ...
            <div class="tab-pane fade" role="tabpanel" id="modal-email-template-block">
              <div class="form-group required">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="modal-error-block" id="modal-error-template-description-language-subject-<?php echo $language['language_id']; ?>"></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                ...
                <div class="col-sm-9">
                  ...
                  <?php } ?>
                  <button class="btn btn-primary btn-sm" type="button" data-toggle="collapse" data-target="#collapse-result-email-sub" aria-expanded="false" aria-controls="collapse-result-email-sub"><?php echo $button_view_shortcodes; ?></button>
                </div>
              </div>
                ...
                <div class="form-group" style="margin-bottom: 0px;">
                  ...
                  <div class="col-sm-9">
                    <div class="well">
                      ...
                      <?php echo $text_result_email_sub_c2; ?><br/>
                    </div>
                  </div>
                </div>
              </div>
