...
<div class="modal-content" id="modal-category-constructor-content">
        ...
        <ul class="nav nav-tabs" id="modal-setting-tabs">
          <li class="active dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="#modal-category-general-block" data-toggle="tab"><i class="fa fa-cogs"></i> <?php echo $tab_general_setting; ?></a></li>
              <li><a href="#modal-category-basic-block" data-toggle="tab"><i class="fa fa-cogs"></i> <?php echo $tab_basic_setting; ?></a></li>
              <li><a href="#modal-category-layout-block" data-toggle="tab"><i class="fa fa-eye"></i> <?php echo $tab_layout_setting; ?></a></li>
              <li><a href="#modal-category-image-block" data-toggle="tab"><i class="fa fa-picture-o"></i> <?php echo $tab_image_setting; ?></a></li>
            </ul>
          </li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="#modal-category-language-block" data-toggle="tab"><i class="fa fa-flag-o"></i> <?php echo $tab_basic_language_setting; ?></a></li>
            </ul>
          </li>
        </ul>
        <form method="post" enctype="multipart/form-data" id="modal-form" class="form-horizontal">
          <input type="hidden" style="display:none;" name="category_id" value="<?php echo $category_id; ?>" />
          <div class="tab-content">
            ...
            <div class="tab-pane fade" role="tabpanel" id="modal-category-basic-block">
                      ...
                      <tbody>
                        <?php foreach ($all_stores as $store) { ?>
                          <tr>
                            ...
                            <td class="text-left">
                              <select name="category_layout[<?php echo $store['store_id']; ?>]" class="form-control input-sm">
                                <option value=""></option>
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label"><?php echo $entry_parent; ?></label>
                <div class="col-sm-9">
                  <input type="text" name="path" value="<?php echo $path; ?>" placeholder="<?php echo $placeholder_category; ?>" class="form-control" />
            ...
            <div class="tab-pane fade" role="tabpanel" id="modal-category-layout-block">
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label" for="input-show_subcategories"><?php echo $entry_show_subcategories; ?></label>
                <div class="col-sm-9">
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label" for="input-show_subcategories_total"><?php echo $entry_show_subcategories_total; ?></label>
                <div class="col-sm-9">
                  <select name="show_subcategories_total" id="input-show_subcategories_total" class="form-control">
                    <?php if ($show_subcategories_total) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_enabled; ?></option>
            ...
            <div class="tab-pane fade" role="tabpanel" id="modal-category-image-block">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <a href="" id="thumb-image0" data-toggle="image_category" data-imgid="0" class="img-thumbnail"><img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                    ...
                    <table id="images" class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        <tr id="image-row<?php echo $image_row; ?>">
                          <td class="text-left"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image_category" data-imgid="<?php echo $image_row; ?>" class="img-thumbnail"><img src="<?php echo $category_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="category_image[<?php echo $image_row; ?>][image]" value="<?php echo $category_image['image']; ?>" id="input-image<?php echo $image_row; ?>" /></td>
            ...
            <div class="tab-pane fade" role="tabpanel" id="modal-category-language-block">
              <div class="form-group required">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="modal-error-block" id="modal-error-category-description-language-name-<?php echo $language['language_id']; ?>"></div>
                  <?php } ?>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="input-group" style="margin-bottom: 5px;">
                    <span class="input-group-addon"><img src="<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                    <input type="text" name="category_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_title'] : ''; ?>" class="form-control" />
                  </div>
                  <div class="modal-error-block" id="modal-error-category-description-language-meta-title-<?php echo $language['language_id']; ?>"></div>
                  <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="modal-error-block" id="modal-error-category-description-language-description-<?php echo $language['language_id']; ?>"></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon"><img src="<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                    <textarea name="category_description[<?php echo $language['language_id']; ?>][meta_description]" id="meta_description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                  </div>
                  <div class="modal-error-block" id="modal-error-category-description-language-meta-description-<?php echo $language['language_id']; ?>"></div>
                  <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon"><img src="<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                    <textarea name="category_description[<?php echo $language['language_id']; ?>][meta_keyword]" id="meta_keyword<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
                  </div>
                  <div class="modal-error-block" id="modal-error-category-description-language-meta-keyword-<?php echo $language['language_id']; ?>"></div>
                  <?php } ?>
              ...
              <div class="form-group pro-block">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon"><img src="<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                    <textarea name="category_description[<?php echo $language['language_id']; ?>][main_image_alt]" id="main_image_alt<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['main_image_alt'] : ''; ?></textarea>
                  </div>
                  <div class="modal-error-block" id="modal-error-category-description-language-main-image-alt-<?php echo $language['language_id']; ?>"></div>
                  <?php } ?>
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-info" onclick="submit_category(this, <?php if ($category_id) { ?>'edit'<?php } else { ?>'add'<?php } ?>);"><?php echo $button_submit; ?></button>
    <button type="button" class="btn btn-danger" data-dismiss="modal" aria-label="Close" <?php if (!$category_id) { ?>style="display: none;"<?php } ?>><?php echo $button_close; ?></button>
  </div>
</div>
		...
		$.ajax({
			...
			success: function(json) {
				response($.map(json, function(item) {
				  if (item['category_id'] && item['category_id'] != '<?php echo $category_id; ?>') {
            return {
              label: item['name'],
...
function addImage() {
	...
	html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '" data-toggle="image_category" data-imgid="' + image_row + '" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="category_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
