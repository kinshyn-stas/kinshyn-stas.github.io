  ...
  function validate(event) {
    ...
    if (!document.getElementById('email').value) {			
            ...
            if (!email.match(emailPattern)) {                
				...
				$('#email').after('<span style="text-align:center;display:block;color:#ff1100">Enter correct e-mail</span>')				
            }
    } else {
      grecaptcha.execute();
    }
		...
		<section class="container-fluid secondblock">
			<div class="row">
				<div class="container">
		            ...
		            Easy-Agency<br>
								Ukraine, Kiev<br>
								<a href="https://goo.gl/maps/vYwZhmkgQAedMqpf6" target="_blank">ave. V. Lobanovsky, 6a</a>
		          </p>
						</div>
