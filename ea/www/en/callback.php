  ...
  function validate(event) {
    ...
    if (!document.getElementById('tel').value) {
            ...
            if (!tel.match(telPattern)) {
				...
				$('#tel').after('<span style="text-align:center;display:block;width:100%;color:#ff1100">Enter correct phone number</span>')
            }
    } else {
      grecaptcha.execute();
    }
				...
				<div class="container">
					<div class="row">
						<div class="col-12 content-part">
							...
							<form id="contactform" class="contactform" action="en/mail/mail.php" method="POST">
								<div class="row">
									<div class="col-12">
										<input type="text" id="tel" name="phone" value="" pattern="(\+?\d[- .]*){7,21}" placeholder="Phone" title="Example: +380999876543" required>
