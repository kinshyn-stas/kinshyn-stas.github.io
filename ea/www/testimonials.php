				...
				<div class="container">
					<div class="row">
						<div class="col-12 head-part">
							<h3 class="frontblock-heading">Отзывы о нашей работе</h3>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row tesmimg-list">
				<div class="col-lg-4 col-12 tesmimg_item">
					<div class="item-info">
						<div class="img__part">
							<img src="/img/tesmimg/inveria.png" alt="" class="item__img">
						</div>
						<h3 class="item__head">Inveria</h3>
						<p class="item__info">Экосистема для интеллектуального и творческого развития</p>
					</div>
				</div>
				<div class="col-lg-4 col-12 tesmimg_item">
					<div class="item-info">
						<div class="img__part">
							<img src="/img/tesmimg/greentechtrade.png" alt="" class="item__img">
						</div>
				...
				<div class="col-lg-4 col-12 tesmimg_item">
					<div class="item-info">
						<div class="img__part">
							<img src="/img/tesmimg/nashformat.png" alt="" class="item__img">
						</div>
						<h3 class="item__head">Наш Формат</h3>
						<p class="item__info">Издательство, специализирующееся на нехудожественной литературе (нон-фикшн)</p>
					</div>
				</div>
				<div class="col-lg-4 col-12 tesmimg_item">
					<div class="item-info">
						<div class="img__part">
							<img src="/img/tesmimg/klitchko.png" alt="" class="item__img">
						</div>
						<h3 class="item__head">Klitschko Expo</h3>
						<p class="item__info">Выставка-музей достижений легендарных братьев Кличко</p>
					</div>
				</div>
				<div class="col-lg-4 col-12 tesmimg_item">
					<div class="item-info">
						<div class="img__part">
							<img src="/img/tesmimg/verabrezhneva.png" alt="" class="item__img">
						</div>
				...
				<div class="col-lg-4 col-12 tesmimg_item">
					<div class="item-info">
						<div class="img__part">
							<img src="/img/tesmimg/selfinv.png" alt="" class="item__img">
						</div>
						<h3 class="item__head">Self Invest</h3>
						<p class="item__info">Легальное трудоустройство студентов в Германии в период зимних и летних каникул</p>
					</div>
				</div>
			</div>
		</div>
		...
		<section class="container-fluid">
			<div class="row">
				...
				<div class="container">
					<div class="row">
						<div class="col-12">
							<h3 class="frontblock-heading">Оставьте отзыв о нас</h3>
						</div>
						<div class="col-12 content-part">
							<form id="contactform" class="contactform" action="mail/mail.php" method="POST">
								<div class="row">
									<div class="col-12">
										<input type="text" name="tesmname" value="" id="tesmname" placeholder="Имя">
									</div>
									<div class="col-12">
										<input type="text" name="tesmposit" value="" id="tesmposit" placeholder="Должность (например, Директор в фирме Антошка)">
									</div>
									<div class="col-12">
