...
//		    (class_exists( 'ASPSUB_main' ) && version_compare( '1.2.5', ASPSUB_main::ADDON_VER ) >= 0 ) ) {
	...
	if ( empty( $content ) ) {
	    ...
	    $output	 = '';
	    $output	 .= '<h2 class="asp-thank-you-page-msg1" style="text-align: center;margin-bottom: 25px;">' . __( "Thank you for your payment.", "stripe-payments" ) . '</h2>';
	    ...
	    $wrap	 .= "<div class='asp-thank-you-page-msg-wrap' style='margin: 10px auto;padding: 15px;max-width: 530px;'>";
	    $output	 = $wrap . $output;
