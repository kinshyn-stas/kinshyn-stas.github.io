...
class MEC_feature_organizers extends MEC_base
{
    ...
    public function save_metadata($term_id)
    {
        ...
        $url = (isset($_POST['url']) and trim($_POST['url'])) ? (strpos($_POST['url'], 'http') === false ? 'http://'.$_POST['url'] : $_POST['url']) : '';
    ...
    public function save_event($post_id)
    {
        ...
        $url = (isset($_mec['organizer']['url']) and trim($_mec['organizer']['url'])) ? (strpos($_mec['organizer']['url'], 'http') === false ? 'http://'.$_mec['organizer']['url'] : $_mec['organizer']['url']) : '';
