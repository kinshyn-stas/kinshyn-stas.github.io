...
?>
    ...
    <div id="owlEvents" class="owl-carousel owl-theme owl-loaded">
		...
		<?php foreach($this->events as $date=>$events): ?>
            ...
            ?>
                ...
                <?php elseif($this->style == 'accordion'): ?>
                    ...
                    <?php elseif($this->style == 'myHomeSlider'): ?>
                        ...
                        <div class="owl-item">
                            <div class="card">
                                <div class="card-img-top">
                                    <div class="card-label">
                                        <div class="card-label-wrap">
                                            <div class="date"><?php echo date_i18n($this->date_format_acc_1, strtotime($event->date['start']['date'])); ?></div>
                                            <div class="month"><?php echo date_i18n($this->date_format_acc_2, strtotime($event->date['start']['date'])); ?></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <a data-event-id="<?php echo $event->data->ID; ?>" href="<?php echo $this->main->get_event_date_permalink($event->data->permalink, $event->date['start']['date']); ?>"><h5 class="card-title mb-xl-2 mFlag-<?= $mClass; ?>"><?php echo $event->data->title; ?></h5></a>
                                    <p class="card-text mb-xl-2"><?= $event->data->post->post_excerpt; ?></p>
                                    <p class="mClass-<?= $mClass; ?>" style="display: none;">
                                        <?= $event->date['start']['date']; ?> <?php echo (date("H:i", mktime(0, 0, $event->data->meta["mec_start_day_seconds"]))); ?>
                                    </p>                                    
                                    <p class="mClassDatSt-<?= $mClass; ?>" style="display: none;">
                                        <?= $event->date['start']['date']; ?>
                                    </p>                                    
                                    <p class="mClassDatFin-<?= $mClass; ?>" style="display: none;">
                                        <?= $event->date['end']['date']; ?>
                                    </p>
                                    <ul class="card-list mb-xl-4">
                                        <li>
                                            <span class="icon">
                                                <img src="/wp-content/themes/visual-composer-starter/img/marker-icon.png" data-rjs="2">
                                            </span>
                                            <span class="mLocEvent-<?= $mClass; ?>"><?php echo (isset($location['name']) ? $location['name'] : ''); ?></span>
                                        </li>
                                        <li>
                                            <span class="icon">
                                                <img src="/wp-content/themes/visual-composer-starter/img/price-icon.png" data-rjs="2">
                                            </span>
                                            <?= $event->data->meta['mec_cost']; ?> $
                                        </li>
                                    </ul>
                                    <a href="<?php echo $this->main->get_event_date_permalink($event->data->permalink, $event->date['start']['date']); ?>#byeticket" class="btn btn-outline-danger-gradient btn-lg btn-block">
