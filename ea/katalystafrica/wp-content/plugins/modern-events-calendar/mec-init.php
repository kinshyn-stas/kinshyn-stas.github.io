...
class MEC
{
    ...
    public static function import($file, $override = true, $return_path = false)
    {
        ...
        if($override)
        {
            ...
            $theme_path = $wp_theme_path .DS. 'webnus' .DS. _MEC_DIRNAME_ .DS. $file;
            ...
            if(get_template_directory() != get_stylesheet_directory())
            {
                ...
                $child_theme_path = get_stylesheet_directory() .DS. 'webnus' .DS. _MEC_DIRNAME_ .DS. $file;
