		  ...
		  // OCFilter end
			...
			*/	
			if ($this->user->hasPermission('access', 'design/banner')) {
			    ...
			    //added
					if ($this->user->hasPermission('access', 'design/banner_extend')) {
						$design[] = array(
							'name'	   => $this->language->get('text_banner') . ' Extend',
							'href'     => $this->url->link('design/banner_extend', 'token=' . $this->session->data['token'], true),
							'children' => array()
						);
					}
				//added
			...
			if ($customer) {
			    ...
			    //added
                if ($this->user->hasPermission('access', 'customer/light_field')) {
                    $customer[] = array(
                        'name'	   => $this->language->get('button_edit_fields'),
                        'href'     => $this->url->link('customer/light_field', 'token=' . $this->session->data['token'], true),
                        'children' => array()
                    );
                }
				//added
