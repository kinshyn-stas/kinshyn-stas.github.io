...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($this->config->get('cheaper_ssp')) {$data['cheaper_ssp'] = $this->config->get('cheaper_ssp');} else {$data['cheaper_ssp'] = 0;}
		if ($this->config->get('cheaper_sspr')) {$data['cheaper_sspr'] = $this->config->get('cheaper_sspr');} else {$data['cheaper_sspr'] = 0;}
		...
		if ($product_info) {
            ...
            $data['schema_description'] = $product_info['meta_description'];
            ...
            //added template
			'src' => $this->model_tool_image->resize($result['image'], $this->config->get($this->config->get('config_theme') . '_image_thumb_width'), $this->config->get($this->config->get('config_theme') . '_image_thumb_height')),
