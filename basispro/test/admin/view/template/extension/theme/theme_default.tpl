            ...
            <div class="form-group required">
              ...
              <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                      <div class="row">
                          <div class="col-sm-6">
                              <input type="text" name="theme_default_image_cart_popup_width" value="<?php echo $theme_default_image_cart_popup_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-cart_popup" class="form-control" />
                          </div>
                          <div class="col-sm-6">
                              <input type="text" name="theme_default_image_cart_popup_height" value="<?php echo $theme_default_image_cart_popup_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                          </div>
                      </div>
                  </div>
              </div>
              <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                      <div class="row">
                          <div class="col-sm-6">
                              <input type="text" name="theme_default_image_subcat_width" value="<?php echo $theme_default_image_subcat_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-subcat" class="form-control" />
                          </div>
                          <div class="col-sm-6">
                              <input type="text" name="theme_default_image_subcat_height" value="<?php echo $theme_default_image_subcat_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                          </div>
                      </div>
                  </div>
              </div>
