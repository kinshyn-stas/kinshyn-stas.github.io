        ...
        <div class="panel panel-default">
				...
				<div class="row">
					<div class="col-sm-10 col-md-offset-1">
						<div id="wrap_profile_export" class="well well-sm">
							<form id="form_profile_setting" class="form-horizontal form-control-sm">
								<div class="form-group form-group-sm">
									<label class="col-sm-4 control-label" data-prop_id="33"><?php echo $text_profile_load; ?></label>
									<div class="col-sm-8">
										<select name="profile_setting_select" id="profile_setting_select" class="form-control input-sm"></select>
									</div>
								</div>
								<div class="form-group form-group-sm">
									<label class="col-sm-4 control-label">&nbsp;</label>
									<div class="col-sm-8">
										<button type="button" style="min-width:120px" class="btn btn-info btn-sm" onclick="loadProfile('profile_setting')"><?php echo $button_load; ?></button>
										<button type="button" style="min-width:120px" class="btn btn-primary btn-sm" onclick="updateProfile('profile_setting')"><?php echo $button_save; ?></button>
									</div>
								</div>
							</form>
						</div>
			...
			<div id="tab_fields" class="tab-pane fade">
				<div class="row">
					<div class="col-sm-10 col-md-offset-1">
						<div id="wrap_profile_export" class="well well-sm">
							<form id="form_profile_fields" class="form-horizontal form-control-sm">
								<div class="form-group form-group-sm">
									<label class="col-sm-4 control-label" data-prop_id="33"><?php echo $text_profile_load; ?></label>
									<div class="col-sm-8">
										<select name="profile_fields_select" id="profile_fields_select" class="form-control input-sm"></select>
									</div>
								</div>
								<div class="form-group form-group-sm">
									<label class="col-sm-4 control-label">&nbsp;</label>
									<div class="col-sm-8">
										<button type="button" style="min-width:120px" class="btn btn-info btn-sm" onclick="loadProfile('profile_fields')"><?php echo $button_load; ?></button>
										<button type="button" style="min-width:120px" class="btn btn-primary btn-sm" onclick="updateProfile('profile_fields')"><?php echo $button_save; ?></button>
									</div>
								</div>
							</form>
						</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										...
										<select name="csv_export[filter_price_prefix]" class="form-control">
											...
											<option value="2"<?php if (isset($csv_export['filter_price_prefix']) && $csv_export['filter_price_prefix'] == 2) { ?> selected="selected"<?php } ?>>&nbsp;&nbsp;&gt;=&nbsp;&nbsp;</option>
											<option value="3"<?php if (isset($csv_export['filter_price_prefix']) && $csv_export['filter_price_prefix'] == 3) { ?> selected="selected"<?php } ?>>&nbsp;&nbsp;&lt;=&nbsp;&nbsp;</option>
											<option value="4"<?php if (isset($csv_export['filter_price_prefix']) && $csv_export['filter_price_prefix'] == 4) { ?> selected="selected"<?php } ?>>&nbsp;&nbsp;&lt;&gt;&nbsp;&nbsp;</option>
										</select>
										</div>
										<div class="col-sm-6">
									...
									<div class="col-sm-7">
										<div class="row">
											...
											<select name="csv_export[filter_quantity_prefix]" class="form-control">
												...
												<option value="2"<?php if (isset($csv_export['filter_quantity_prefix']) && $csv_export['filter_quantity_prefix'] == 2) { ?> selected="selected"<?php } ?>>&nbsp;&nbsp;&gt;=&nbsp;&nbsp;</option>
												<option value="3"<?php if (isset($csv_export['filter_quantity_prefix']) && $csv_export['filter_quantity_prefix'] == 3) { ?> selected="selected"<?php } ?>>&nbsp;&nbsp;&lt;=&nbsp;&nbsp;</option>
												<option value="4"<?php if (isset($csv_export['filter_quantity_prefix']) && $csv_export['filter_quantity_prefix'] == 4) { ?> selected="selected"<?php } ?>>&nbsp;&nbsp;&lt;&gt;&nbsp;&nbsp;</option>
									...
									<tr id="row_<?php echo $field['uid']; ?>">
										<td>
											<label class="control-label" title="<?php echo $fields_set_help[$field['uid']]; ?> <?php echo $field['uid']; ?>">
												<input <?php if (array_key_exists($field['uid'], $csv_export['fields_set'])) { ?> checked="checked" <?php } ?> type="checkbox" id="<?php echo $field['uid']; ?>" name="csv_export[fields_set][<?php echo $field['uid']; ?>]" value="1" />
				...
				<form action="<?php echo $action_import; ?>" method="post" id="form_product_import" enctype="multipart/form-data" class="form-horizontal">
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="form-group form-group-sm">
								<label class="col-sm-5 control-label"><?php echo $entry_import_related_type; ?></label>
								<div class="col-sm-7">
									<select name="csv_import[import_related_type]" class="form-control input-sm">
										<option value="0"<?php if ( !isset($csv_import['import_related_type']) || $csv_import['import_related_type'] == 0 ) { ?> selected="selected"<?php } ?>><?php echo $text_related_both; ?></option>
										<option value="1"<?php if ( isset($csv_import['import_related_type']) && $csv_import['import_related_type'] == 1 ) { ?> selected="selected"<?php } ?>><?php echo $text_related_irreciprocal; ?></option>
									</select>
								</div>
							</div>
						</div>
								...
								<table id="table-macros-field" class="table table-hover table-striped">
									...
									<?php foreach ($product_macros as $fields) { ?>
										<tr id="macros-field-row<?php echo $field_row; ?>">
											<td class="text-left"><input type="hidden" name="product_macros[<?php echo $field_row; ?>][tbl_name]" value="<?php echo $fields['tbl_name']; ?>"/><?php echo $fields['tbl_name']; ?></td>
											<td class="text-left"><input type="hidden" name="product_macros[<?php echo $field_row; ?>][field_name]" value="<?php echo $fields['field_name']; ?>"/><?php echo $fields['field_name']; ?></td>
											<td class="text-left"><input type="hidden" name="product_macros[<?php echo $field_row; ?>][csv_name]" value="<?php echo $fields['csv_name']; ?>"/><?php echo $fields['csv_name']; ?></td>
											<td class="text-left"><input type="hidden" name="product_macros[<?php echo $field_row; ?>][csv_caption]" value="<?php echo $fields['csv_caption']; ?>"/><?php echo $fields['csv_caption']; ?></td>
...
<script type="text/javascript">
	...
	function loadProfile(key) {
		...
		var url = '<?php echo $action; ?>&profile_type=' + key +'&profile_id=' + $( '#' + key + '_select' + ' option:selected').val();
		url = url.replace( /\&amp;/g, '&' );
	...
	jQuery(document).ready(function ($) {
		...
		getProfile('profile_setting', <?php echo (isset($profile_id)) ? $profile_id : 0; ?>);
		getProfile('profile_fields', <?php echo (isset($profile_id)) ? $profile_id : 0; ?>);
	});
</script>
<script>
	jQuery(document).ready(function ($) {
