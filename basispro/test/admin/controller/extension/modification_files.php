...
class ControllerExtensionModificationFiles extends Controller {
    ...
    public function index() {
        $this->load->language('extension/modification_files');
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/modification_files', 'token=' . $this->session->data['token'], true)
        );
        ...
        $this->response->setOutput($this->load->view('extension/modification_files.tpl', $data));
    }
    ...
    private function getModifiedFiles() {
        ...
        foreach($cache_files as $cache_file) {
            ...
            $result[] = array(
                'file' => $cache_file,
                'view' => $this->url->link('extension/modification_diff', 'token=' . $this->session->data['token'] . '&file_patch=' . $cache_file, true),
