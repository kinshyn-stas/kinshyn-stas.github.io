...
class ControllerExtensionThemeThemeDefault extends Controller {
	...
	public function index() {
		...
		//added pasha_st
		if (isset($this->request->post['theme_default_image_subcat_width'])) {
			$data['theme_default_image_subcat_width'] = $this->request->post['theme_default_image_subcat_width'];
		} elseif (isset($setting_info['theme_default_image_subcat_width'])) {
			$data['theme_default_image_subcat_width'] = $setting_info['theme_default_image_subcat_width'];
		} else {
			$data['theme_default_image_subcat_width'] = 70;
		}

		if (isset($this->request->post['theme_default_image_subcat_height'])) {
			$data['theme_default_image_subcat_height'] = $this->request->post['theme_default_image_subcat_height'];
		} elseif (isset($setting_info['theme_default_image_subcat_height'])) {
			$data['theme_default_image_subcat_height'] = $setting_info['theme_default_image_subcat_height'];
		} else {
			$data['theme_default_image_subcat_height'] = 70;
		}

		if (isset($this->request->post['theme_default_image_cart_popup_width'])) {
			$data['theme_default_image_cart_popup_width'] = $this->request->post['theme_default_image_cart_popup_width'];
		} elseif (isset($setting_info['theme_default_image_cart_popup_width'])) {
			$data['theme_default_image_cart_popup_width'] = $setting_info['theme_default_image_cart_popup_width'];
		} else {
			$data['theme_default_image_cart_popup_width'] = 70;
		}

		if (isset($this->request->post['theme_default_image_cart_popup_height'])) {
			$data['theme_default_image_cart_popup_height'] = $this->request->post['theme_default_image_cart_popup_height'];
		} elseif (isset($setting_info['theme_default_image_cart_popup_height'])) {
			$data['theme_default_image_cart_popup_height'] = $setting_info['theme_default_image_cart_popup_height'];
		} else {
			$data['theme_default_image_cart_popup_height'] = 70;
		}
		//added pasha_st
