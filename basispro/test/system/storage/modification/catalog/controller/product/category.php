...
/*			$results = $this->model_catalog_category->getCategories($category_id);
            ...
            //added template
            if ($result['image']) {
                $image = $this->model_tool_image->resize($result['image'], $this->config->get($this->config->get('config_theme') . '_image_subcat_width'), $this->config->get($this->config->get('config_theme') . '_image_subcat_height'));
            } else {
                $image = $this->model_tool_image->resize('placeholder.png', $this->config->get($this->config->get('config_theme') . '_image_subcat_width'), $this->config->get($this->config->get('config_theme') . '_image_subcat_height'));
            }
            //added template
