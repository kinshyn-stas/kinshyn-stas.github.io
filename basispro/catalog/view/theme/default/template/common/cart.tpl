                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-xs-8 product-count" >
                            ...
                            <span class="input-group-btn">
                                <button type="button" class="btn btn-default" onclick="cart.liveupdate('<?php echo $product['cart_id']; ?>', parseFloat($('#input-quantity-<?php echo $product['cart_id']; ?>').val())-1);">
                                    <span class="fa fa-minus"></span>
                                </button>
                            </span>
                                <input type="text" name="quantity" id="input-quantity-<?php echo $product['cart_id']; ?>" class="form-control input-number" value="<?php echo $product['quantity']; ?>"  onchange="cart.liveupdate('<?php echo $product['cart_id']; ?>', parseFloat($(this).val()));">
                            <span class="input-group-btn">
                                <button type="button" class="btn btn-default" onclick="cart.liveupdate('<?php echo $product['cart_id']; ?>', parseFloat($('#input-quantity-<?php echo $product['cart_id']; ?>').val())+1);">
