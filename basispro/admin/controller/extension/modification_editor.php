...
EOT;
        ...
        $data['button_erase_data']  = $this->language->get('button_erase_data');
        $data['button_erase_image'] = $this->language->get('button_erase_image');
        ...
        $this->response->setOutput($this->load->view('extension/modification_editor', $data));
    }
